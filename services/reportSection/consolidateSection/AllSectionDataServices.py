...
from services.reportSection.financialHighlights.sectionData.SectionData import FinancialHighlightSectionDataService 
from services.reportSection.profitAbility.sectionData.SectionDataPA import ProfitAbilityDataService
from services.reportSection.expensesAnalysis.sectionData.SectionDataEA import ExpensesAnalysisDataService
from services.reportSection.cashFlowAnalysis.sectionData.SectionDataCF import CashFlowAnalysisDataService
from services.reportSection.breakEvenAnalysis.sectionData.SectionDataBE import BreakEvenDataService
...
class AllSectionDataService:
    ...
    def __init__(
        ...
        self.months = [i for i in range(1, months[-1]+1)] if reportType.lower() == "year" else months
    ...
    def getFinancialHighlightsSection(self) -> Result:
        ...
        try:
            ...
            FH_Obj = FinancialHighlightSectionDataService(self.year,  self.reportType, sectionName, self.reportId,self.months)
    ...
    def getExpensesAnalysisSection(self) -> Result:
        ...
        try:
            ...
            EXP_Obj =  ExpensesAnalysisDataService(self.year,  self.reportType,sectionName, self.reportId,self.months)
    ...
    def getCashFlowSection(self) -> Result:
        ...
        try:
            ...
            CF_Obj = CashFlowAnalysisDataService(self.year,  self.reportType, sectionName, self.reportId,self.months)
    ...
    def getProfitablitySection(self) -> Result:
        ...
        try:
            ...
            # Retrieve individual data types
            PA_Obj = ProfitAbilityDataService(self.year,  self.reportType, sectionName , self.reportId,self.months)
    ...
    def getBreakEvenAnalysisSection(self) -> Result:
        ...
        try:
            ...
            BE_Obj = BreakEvenDataService(self.year,  self.reportType, sectionName, self.reportId,self.months)
