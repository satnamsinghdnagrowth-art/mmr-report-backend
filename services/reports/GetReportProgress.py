    ...
    try:
        ...
        if os.path.exists(metaFilePath):
            with open(metaFilePath, "r") as f:
                ...
                return Result(Data=existing_data, Status=1, Message="Executive Summary Saved Successfully"
                )
        ...
        if templateId is not None:
            ...
            return Result(Status=1, Message="Data not avaible, user has choosen to create report from scratch"
                )
